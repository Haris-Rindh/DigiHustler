...
export const INITIAL_USERS: User[] = [
    ...
    notes: [
      {
        ...
        text: 'Founding Director with executive override permissions.',
      },
    ],
    statusHistory: [
      {
        ...
        to: 'active',
        reason: 'Platform initialization & entity founding.',
        changedBy: 'System Core',
      },
    ],
    documents: [
      { id: 'doc-1', name: 'Incorporation_Agreement.pdf', type: 'contract', url: '#', uploadedAt: '2024-01-15' },
    ],
  },
    ...
    notes: [
      {
        ...
        authorId: 'usr-mgmt-1',
        authorName: 'Haris Asad',
        text: 'Promoted to Group Leader after exceptional delivery on the Estates Direct UK portal.',
      },
    ],
    statusHistory: [
      {
        ...
        from: 'pending_onboarding',
        to: 'active',
        reason: 'Graduated Digiskill Batch 12 top 1%.',
        changedBy: 'Haris Asad',
      },
    ],
    documents: [
      { id: 'doc-2', name: 'Digiskill_Certificate_DS12.pdf', type: 'id_verification', url: '#', uploadedAt: '2024-06-10' },
    ],
  },
  {
    id: 'usr-ldr-creative',
    ...
    statusHistory: [
      {
        ...
        from: 'pending_onboarding',
        to: 'active',
        reason: 'Initial verification approved.',
        changedBy: 'Haris Asad',
      },
    ],
    documents: [],
    ...
    notes: [
      {
        ...
        authorId: 'usr-mgmt-1',
        authorName: 'Haris Asad',
        text: 'On approved leave until Sept 1st for university exams.',
      },
    ],
    statusHistory: [
      {
        ...
        from: 'active',
        to: 'on_leave',
        reason: 'Temporary study leave requested.',
        changedBy: 'Haris Asad',
      },
    ],
    documents: [],
  ...
  {
    id: 'usr-fl-tech-suspended',
    name: 'Danish Qureshi',
    email: 'danish.q@digihust.com',
    phone: '+92 322 7766554',
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=250',
    role: 'freelancer',
    groupId: 'tech',
    title: 'Full Stack Developer',
    specialties: ['Vue.js', 'Express', 'MySQL'],
    ...
    notes: [
      {
        ...
        authorId: 'usr-mgmt-1',
        authorName: 'Haris Asad',
        text: 'Suspended due to unexcused milestone delay on client sprint. Historical record preserved.',
      },
    ],
    statusHistory: [
      {
        ...
        from: 'active',
        to: 'suspended',
        reason: 'Milestone SLA breach under review.',
        changedBy: 'Haris Asad',
      },
    ],
    documents: [],
