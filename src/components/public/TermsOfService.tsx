    ...
    <div className="pt-16">
      ...
      <section className="bg-[var(--bg-page)] py-16 px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-8 text-[var(--text-body)] leading-relaxed text-sm sm:text-base">
          <div>
            <h2 className="font-display font-bold text-2xl text-[var(--text-heading)] mb-3">1. Scope of Engagement</h2>
            <p>
          ...
          <div>
            <h2 className="font-display font-bold text-2xl text-[var(--text-heading)] mb-3">4. Post-Launch Warranty & Support</h2>
            <p>
          ...
          <div>
            <h2 className="font-display font-bold text-2xl text-[var(--text-heading)] mb-3">5. Inquiries & Legal Notices</h2>
            <p>
              For legal inquiries or corporate contracts, contact our legal counsel at <a href="mailto:legal@digihust.com" className="text-[var(--brand-teal)] font-bold underline">legal@digihust.com</a>.
            </p>
          </div>
        </div>
      </section>
