...
export const Home: React.FC = () => {
  return (
    <div className="pt-16">
      ...
      {/* ── SECTION 1: HERO ── */}
      <section className="bg-[#071e26] min-h-[92vh] flex items-center px-6 lg:px-8">
        <div className="max-w-7xl mx-auto w-full py-24 lg:py-32">
          <div className="max-w-3xl">

            {/* Label */}
            <div className="inline-flex items-center space-x-2 px-3 py-1.5 rounded-full border border-[#1e4a5d] text-[#bde0fe] text-xs font-semibold uppercase tracking-wider mb-8">
              <span className="w-1.5 h-1.5 rounded-full bg-[#1a7a8c] animate-pulse" />
              <span>Pakistan's Specialist Digital Team</span>
            </div>

            {/* Headline */}
            <h1 className="font-display font-extrabold text-5xl sm:text-6xl lg:text-7xl text-white leading-[1.05] tracking-tight mb-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-14">
              <Link to="/contact"
                className="flex items-center space-x-2 px-7 py-4 rounded-xl bg-[#1a7a8c] hover:bg-[#156575] text-white font-bold text-base shadow-lg transition-all">
                <span>Get a Quote</span>
                <ArrowRight className="w-4 h-4" />
              </Link>
              <Link to="/services"
                className="flex items-center space-x-2 px-7 py-4 rounded-xl border border-[#1e4a5d] hover:border-[#1a7a8c] text-slate-200 font-bold text-base transition-all hover:bg-[#1a7a8c]/10">
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-slate-500">
              {['Web Development', 'Design', 'AI & Automation', 'Marketing', 'Cybersecurity', 'More'].map((t, i) => (
