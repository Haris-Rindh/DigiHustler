...
export const NewLeadModal: React.FC<Props> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
      <div className="relative w-full max-w-xl bg-slate-900 border border-white/10 rounded-3xl shadow-2xl p-6 sm:p-8 animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="font-display font-extrabold text-xl text-white">Capture New Client Lead</h2>
              <p className="text-xs text-slate-400">Step 1 in DigiHust workflow: Submit lead for Management Review</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-1">Project Title / Goal *</label>
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-slate-950 border border-white/10 rounded-xl pl-9 pr-3 py-2 text-sm text-white focus:border-cyan-400 focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">Client Contact Name *</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">Client Company (Optional)</label>
              <div className="relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">Client Email Address *</label>
              <div className="relative">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-1">Client Brief & Scope Overview *</label>
            <textarea
              required
              rows={3}
              ...
              className="w-full bg-slate-950 border border-white/10 rounded-xl p-3 text-sm text-white focus:border-cyan-400 focus:outline-none"
            />
          </div>
